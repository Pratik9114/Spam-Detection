          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  to="/how-it-works"
                  className="inline-flex justify-center items-center border-2 border-green-500 dark:border-green-400 text-green-500 dark:text-green-400 px-8 py-3 rounded-lg hover:bg-green-500/10 transition-colors"
                >
                  See How It Works
                </Link>
              </div>
